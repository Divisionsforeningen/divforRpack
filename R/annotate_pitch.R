...
#'
#' @param colour Color of pitch outline.
#' @param fill Color of pitch fill.
...
#' @param linewidth The line width of the pitch markings
#' @param alpha The transparency of the pitch markings and fill
#' @param linetype The line type of the pitch markings (e.g. "dotted")
#'
...
annotate_pitch <- function(colour = "dimgray",
  ...
  limit_layers <- list(
    ggplot2::xlim(
      dimensions$origin_x - 3,
      dimensions$origin_x + dimensions$length + 3
    ),
    ggplot2::ylim(
      dimensions$origin_y - 5,
